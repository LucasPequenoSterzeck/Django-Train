...
from django.contrib.asuth.models import User
...
class SignUpForm(UserCreationForm):
    ...
    numero_CS = forms.CharField(label="", max_length=10, widget=forms.NumberInput(attrs={'class':'form-control', 'placeholder':'Número CS'}))

    class Meta:
        model = User
        fields = ('username','first_name','last_Name','email','password1','password2','numero_cs')
